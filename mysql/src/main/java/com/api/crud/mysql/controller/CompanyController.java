...
public class CompanyController {
	...
	@PostMapping
	public ResponseEntity<OutsourcedWorker> createWorker(@RequestBody OutsourcedWorker outsourcedWorker) {
		return new ResponseEntity<>(workerService.createWorker(outsourcedWorker), CREATED);	
	}
